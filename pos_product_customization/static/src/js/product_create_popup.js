odoo.define('pos_product_customization.product_create_popup', function(require) {
    'use strict';
...
//            console.log(x, this.props.reserve)
//            console.log(this.props.product, this.props.reserve)
        }
...
//            console.log(this.state.wareValue)
            if (!this.state.wareValue && !reserve) {

odoo.define('pos_salesperson.SalesSelectionPopup', function (require) {
    'use strict';
    ...
    class SelectionPopupSalesperson extends AbstractAwaitablePopup {
        /**
    ...
    SelectionPopupSalesperson.template = 'SalespersonSelectionPopupWidget';
    SelectionPopupSalesperson.defaultProps = {
    ...
    Registries.Component.add(SelectionPopupSalesperson);

    return SelectionPopupSalesperson;
});